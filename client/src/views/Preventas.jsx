  ...
  useEffect(() => {
    const cargarLibros = async () => {
        ...
        try {
            ...
            console.error("Error al cargar libros en Preventas:", error)
        } finally {
            setLoading(false)
        }
    }
        ...
        <>
            <div className="section-header">
                <div className="container">
                    <h1>Preventas <i className="fa-light fa-calendar-clock"></i></h1>
                </div>
            </div>
            ...
            <div className="container pt-5">
                ...
                {loading ? (
                    ...
                    <div className="text-center py-5">
                        <i className="fa-regular fa-clock fa-3x mb-3" style={{ color: '#6B705C' }}></i>
                        <h5 className="fw-semibold">No hay libros en Preventas</h5>
                        <p className="text-secondary">Vuelve pronto, estamos preparando nuevos lanzamientos.</p>
                    </div>
                ) : (
